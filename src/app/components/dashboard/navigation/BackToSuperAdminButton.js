 ...
 * 
 * File: app/components/dashboard/navigation/BackToSuperAdminButton.js
...
function BackToSuperAdminButton(props) {
  // Component implementation would be here
  return (
    <div className="BackToSuperAdminButton">
