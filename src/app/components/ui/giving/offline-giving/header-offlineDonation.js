 ...
 * 
 * File: app/components/ui/giving/offline-giving/header-offlineDonation.js
...
function header-offlineDonation(props) {
  // Component implementation would be here
  return (
    <div className="header-offlineDonation">
