/**
 * group-header-offline-donation.js
 * 
 ...
 * 
 * File: app/components/ui/giving/offline-giving/group-header-offline-donation.js
...
function group-header-offline-donation(props) {
  // Component implementation would be here
  return (
    <div className="group-header-offline-donation">
