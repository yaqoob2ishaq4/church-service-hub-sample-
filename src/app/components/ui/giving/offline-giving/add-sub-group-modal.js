 ...
 * 
 * File: app/components/ui/giving/offline-giving/add-sub-group-modal.js
...
function add-sub-group-modal(props) {
  // Component implementation would be here
  return (
    <div className="add-sub-group-modal">
