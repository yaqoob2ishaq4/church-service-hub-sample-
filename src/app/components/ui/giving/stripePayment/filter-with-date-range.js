 ...
 * 
 * File: app/components/ui/giving/stripePayment/filter-with-date-range.js
...
function filter-with-date-range(props) {
  // Component implementation would be here
  return (
    <div className="filter-with-date-range">
