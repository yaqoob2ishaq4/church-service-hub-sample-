 ...
 * 
 * File: app/components/ui/all-churches/ChurchUserInformation.js
...
function ChurchUserInformation(props) {
  // Component implementation would be here
  return (
    <div className="ChurchUserInformation">
