 ...
 * 
 * File: app/components/forms/member/worker-role-permission..js
...
function worker-role-permission(props) {
  // Component implementation would be here
  return (
    <div className="worker-role-permission">
