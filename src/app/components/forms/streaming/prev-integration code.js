 ...
 * 
 * File: app/components/forms/streaming/prev-integration code.js
...
function prev-integration code(props) {
  // Component implementation would be here
  return (
    <div className="prev-integration code">
