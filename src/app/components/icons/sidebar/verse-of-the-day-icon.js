 ...
 * 
 * File: app/components/icons/sidebar/verse-of-the-day-icon.js
...
function verse-of-the-day-icon(props) {
  // Component implementation would be here
  return (
    <div className="verse-of-the-day-icon">
